...
logo1_image = pygame.image.load("src/images/Dora.png")
logo1_image = pygame.transform.scale(logo1_image, (350, 200))
logo2_image = pygame.image.load("src/images/sega.png")
logo2_image = pygame.transform.scale(logo2_image, (350, 250))

# Set the animation duration
animation_duration = 4  # in seconds
...
while running:
    ...
    if total_elapsed_time < animation_duration:
        if not played_sound_soga:
            pygame.mixer.music.load('src/sound/opening_sound/soga.mpga')
            pygame.mixer.music.set_volume(1.0)  # Increase volume to maximum (1.0)
            pygame.mixer.music.play()
            played_sound_soga = True
        animate_logo(logo2_image, 0, 0, start_time, animation_duration)
        ...
        animate_logo(logo1_image, 0, 0, start_time + animation_duration, animation_duration)
    else:
